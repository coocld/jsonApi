        ...
        JSON:
            ...
            --- 成功 ---
            {
                ...
                "data": {
					...
					"smart"	: "0", /*是否开启一键投标，1-开启、0-未开启*/
					"lcate"	: "", /*-1 不限、hao-好稳赢、car-车金融*/
                    "addtime": "0",
...
* 自动投标设置 /user/autobid/[do] or do=[do] (详细见web版)
    * 请求方式: POST
        ...
        lcate       |   string	|   是      |   可投项目：hao-好稳赢、car-车金融、-1 不限
...
* 开启一键投标 /user/autobid/smartautobid  do=[do] (详细见web版)
    * 请求方式: POST
    
        参数名      |   类型    |   必需    |   说明
        :---        |   :---:   |   :---:   |   :---
        do          |   string  |   是      |   操作类型：close-关闭,enable-开启
                    ...
                    "list": [
                        {
                            ...
                            "score": "13947.2", /*总积分*/
                            "remark": "", /*备注*/
                            "addtime": "1385710726", /*使用时间*/
                            "uptime": "0", /*更新时间*/
                            "status": "1", /*状态: 0-待确认, 1-正常, 2-冻结*/
        ...
        JSON:
            ...
            --- 成功 ---
            {
                ...
                "data": {
                    "address": {
                        "name": "杨华", /*收货人姓名*/
                        "province": "110000", /*收货省份ID*/
                        "city": "110100", /*收货人城市ID*/
                        "address": "北京市海淀区", /*街道地址*/
                        "mobile": "13333333333", /*收货人手机号*/
                        "phone": "", /*固话*/
                        "email": "", /*邮件地址*/
                        "postcode": "", /*邮编*/
                        "uid": "100001", /*用户UID*/
                        "uptime": 1387512957, /*修改时间*/
                        "addtime": 1387512957, /*添加时间*/
                        "id": 46 /*地址编号*/
                    }
                }
            }
                    ...
                    "list": [
                        {
                            ...
                            "tid": "0", /*投标ID*/
                            "ruid": "0", /*相关UID*/
                            "money": "-2000.00", /*操作金额:<0-支出,>0-存入*/
                            "amount": "85292.97", /*可用余额*/
                            "freeze": "15049.00", /*冻结金额*/
                            "remark": "", /*备注*/
                            "addtime": "1383626469", /*添加时间*/
                            "uptime": "0", /*更新时间*/
                            "sync": "0", /*同步标识: 0-无需同步, 1-未同步, 2-已同步, 3-同步失败*/
                            "pflag": "0", /*扣款标识: 0-默认, 1-还款, 2-投标, 3-已投标*/
                            "status": "1", /*状态: 0-待确认, 1-正常, 2-冻结*/
...
* 获取提现用户信息、银行卡信息及其它配置 /user/drawcash/info (提现方式、手机费率、每张卡可提现金额等)
        ...
        JSON:
            ...
            --- 成功 ---
            {
                ...
                "data": {
                    ...
                    "cardlist": [ /*用户提现银行卡信息,isdef=1表示为默认，如果没有默认的，就选择第一个。请参考银行卡管理*/
                        {
                            id": "392",
                            ...
                            "status": "11", /*状态:1-无效,11-待审核,21-已审核,22-已绑定*/
                            "addtime": "1379079707", /*添加时间*/
                            "uptime": "1379258161", /*更新时间*/
                            "exclude": "0.00", /*该卡需提现额度，可以忽略*/
                            "limit": "10000.00" /*该卡可提现额度，提现银行卡选择时显示*/
                        },
                    ],
                    "cardbank": [ /*银行列表*/
                        {
                    ...
                    "list": [
                        {
                            ...
                            "addtime": "1387505461", /*提现时间*/
                            "oktime": "0", /*成功时间*/
                            "uptime": "0", /*更新时间*/
                            "addip": "111.174.210.103", /*提现时IP*/
                            "upip": "", /*更新IP*/
                            "remark": "", /*备注*/
                            "aremark": "", /*管理员备注*/
                            "status": "11", /*状态:1-失败,2-无效,11-等待处理,21-提现处理中,31-提现成功*/
                    ...
                    "list": [
                        {
                            ...
                            "code": "icbc",/*银行标识码*/
                            "card": "5201351451****1311",/*银行卡号*/
                            "status": "11",/*状态:11-待审核,21-已审核-22-已绑定同卡进出*/
                            "addtime": "1379079707",
                            "uptime": "1379258161"
                        }
                    ]
    ...
    * 返回结果：JSON | XML
        ...
        JSON:
            
            {
                ...
                "data": [
                    {
                        "no": "309100001194", /*支行标识*/
                        "branch": "兴业银行股份有限公司北京花园路支行" /*支行名称*/
                    },
                    ...
                ]
            }

* 银行卡管理-新增银行卡 /user/bank/add
...
* 银行卡管理-设置默认银行卡 /user/bank/setdef
    ...
    1. 上传头像图片 /upload/avatar
        ...
        * 返回结果： JSON
            ...
            JSON:
                ...
                {
                    "return": 1,
                    "name": "Desert.jpg", /*上传时本地图片名称*/
                    "type": "jpeg", /*图片类型*/
                    "size": 845941, /*图片大小/字节*/
                    "extension": "jpg", /*文件扩展名*/
                    "savename": "105342_tmp_avatar.jpg", /*保存后的图片名称*/
                    "width": 1024, /*图片宽度*/
                    "height": 768, /*图片高度*/
                    "mime": "image/jpeg", /*图片类型*/
                    "saveurl": "/public/upload/tmp/avatar/105342_tmp_avatar.jpg" /*图片访问地址*/
                }
                    ...
                    "list": [
                        {
                            "id": "211256", /*记录编号*/
                            "uid": "105342", /*用户ID*/
                            "login_time": "1387510695", /*登录时间戳*/
                            "login_ip": "111.173.9.13", /*登录IP*/
                            "logout_time": "0", /*登出时间*/
                            "status": "1", /*状态:0-不显示,1-显示*/
                            "login_date": "2013-12-20 11:38:15", /*登录格式化时间*/
                            "logout_date": "", /*登出格式化时间*/
                            "login_area": "湖北省武汉市" /*登录区域*/
                        },
                        ...
                    ]
                }
    ...
    * 返回结果： JSON
        ...
        JSON:
            ...
            --- 成功 ---
            {
                "return": 1,
                "data": {
                    "post_times": "13", /*贷款申请次数*/
                    "borrow_amount": "520000.00", /*借款金额*/
                    "borrow_times": "4", /*借款成功次数*/
                    "return_amount": "524386.67", /*已还本息*/
                    "remain_amount": "33716033.71", /*待还本息*/
                    "loan_fee": "1800600.00", /*贷款管理费*/
                    "return_times": "3", /*正常还清笔数*/
                    "remain_times": "1",  /*剩余还清笔数*/
                    "system_times": "0" /*平台代还笔数*/
                }
            }
    ...
    * 返回结果： JSON
        ...
        JSON:

            {
                ...
                "data": {
                    "uid": "100001",
                    "auth_realname": "0", /*认证状态:0-未认证,1-已认证*/
                    "auth_mobile": "1", /*手机认证状态*/
                    "auth_email": "1", /*邮箱认证状态*/
                    "auth_avatar": "0", /*头像*/
                    "gender": "1", /*性别*/
                    "auth_gender": "0", /*认证状态*/
                    "birthdate": "1979-04-07", /*出生日期*/
                    "auth_birthdate": "0", /*认证状态*/
                    "idcard_province": "420000", /*户口省份*/
                    "idcard_city": "420900", /*户口城市*/
                    "province": "420000", /*居住省份*/
                    "city": "420100", /*居住城市*/
                    "district": "0", /*区域*/
                    "address": "泰合广场802室", /*地址*/
                    "auth_address": "0", /*地址认证状态*/
                    "address_phone": "027-6666****", /*居住地联系方式*/
                    "auth_address_phone": "0", /*居住地固话*/
                    "education": "3", /*学历:0-未知,1-高中或以下,2-大专,3-本科,4-研究生或以上*/
                    "auth_education": "0", /*学历认证状态*/
                    "graduated_year": "0", /*毕业年份*/
                    "auth_graduated_year": "0", /*毕业年份认证状态*/
                    "graduated_school": "", /*毕业学校*/
                    "auth_graduated_school": "0", /*毕业学校认证*/
                    "marriage": "1", /*婚姻状况:0-未知,1-已婚,2-离异,3-未婚*/
                    "auth_marriage": "0", /*认证状态*/
                    "have_child": "1", /*有无子女:0-未知,1-有,2-无*/
                    "auth_have_child": "0", /*认证状态*/
                    "have_house": "1", /*住房情况:0-未知,1-无,2-商品房,3-自建房*/
                    "auth_have_house": "1", /*住房认证状况*/
                    "house_loan": "2", /*有无房贷:0-未知,1-有,2-无*/
                    "auth_house_loan": "0", /*房贷认证状态*/
                    "have_car": "1", /*是否有车:0-未知,1-有,2-无*/
                    "auth_have_car": "0", /*认证状态*/
                    "car_brand": "", /*车辆品牌*/
                    "auth_car_brand": "0", /*车辆品牌认证*/
                    "car_year": "0", /*购车年份*/
                    "auth_car_year": "0", /*购车年份认证*/
                    "car_loan": "2", /*有无车贷:0-未知,1-有,2-无*/
                    "auth_car_loan": "0", /*车贷认证*/
                    "job_company": "武汉一起好", /*单位名称或个人*/
                    "auth_job_company": "0", /*工作认证状态*/
                    "job_type": "2", /*工作类型: 0-未知, 1-工薪阶层,2-私营企业主,3-自由职业,4-网络商家,5-其他'*/
                    "auth_job_type": "0", /*工资类型认证*/
                    "job_company_type": "8", /*公司类别*/
                    "auth_job_company_type": "0", /*认证状态*/
                    "job_company_scale": "2", /*公司规模*/
                    "auth_job_company_scale": "0", /*公司规模认证*/
                    "job_industry": "2", /*行业*/
                    "auth_job_industry": "0", /*行业认证状态*/
                    "job_title": "CEO", /*职位*/
                    "auth_job_title": "0", /*职位认证状态*/
                    "job_salary": "4", /*月收入*/
                    "auth_job_salary": "0", /*收入认证状态*/
                    "job_years": "1", /*工作年限*/
                    "auth_job_years": "0", /*认证状态*/
                    "job_email": "qishouyan@qq.com", /*工作邮箱*/
                    "auth_job_email": "0", /*认证状态*/
                    "job_province": "420000", /*工作省份*/
                    "auth_job_province": "0", /*认证状态*/
                    "job_city": "420100", /*工资城市*/
                    "auth_job_city": "0", /*认证状态*/
                    "job_company_address": "泰合广场", /*工资地址*/
                    "auth_job_company_address": "0", /*认证状态*/
                    "job_company_phone": "027-8557****", /*公司固话*/
                    "auth_job_company_phone": "0", /*认证状态*/
                    "family_name": "祁守津", /*企业法人*/
                    "auth_family_name": "0", /*认证状态*/
                    "family_who": "兄弟", /*关系*/
                    "auth_family_who": "0", /*认证状态*/
                    "family_phone": "1867403****", /*联系人电话*/
                    "auth_family_phone": "0", /*认证状态*/
                    "other_name": "张东", /*同上*/
                    "auth_other_name": "0",
                    "other_who": "好友",
                    "auth_other_who": "0",
                    ...
                    "addtime": "1348796075",
                    "uptime": "1350743687",
                    "status": "11", /*状态:1-审核失败,2-无效,11-待审核,21-审核成功*/
                    "realname": "祁守艳", /*真实姓名*/
                    "avatar": "/public/upload/avatar/1/100001_avatar_200x200.jpg", /*头像访问地址*/
                    "idcard": "42098*********7518" /*身份证号*/
                }
            }
...
* 认证支付接口-获取认证支付信息(即获取绑定银行卡或充值支付参数) /user/authpay/info
    * 请求方式: GET
        
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
        money   |   string  |   否      |   支付金额，绑卡时不需要带，默认为0.01
        paytype |   string  |   否      |   支付接口类型:llpauth-连连,bfpauth-宝付,rxpauth-融信，默认为由服务端控制
    ...
    * 返回结果：JSON | XML
        ...
        JSON: 
            ...
            分两种情况
            --- 1、成功：已绑卡或不需要补填信息，直接将支付请求参数传入sdk进行支付请求 ---
            {
                "return": 1, /*详细见下面的补填信息接口*/
                "data": {
                    "url":"", /*支付网关地址*/
                    "query":{} /*支付请求参数，有可能是字符串*/
                    "paytype": "llpauth" /*支付接口类型:llpauth-连连,bfpauth-宝付*/
                }
            }
            ...
            --- 宝付认证支付返回 ---
            {
                ...
                "data": {
                    ...
                    "query":
                    "MemberID=100000178&TerminalID=10000001&InterfaceVersion=4.0&PayID=&TradeDate=20150503154959&TransID=1888080800000018&OrderMoney=1&CommondityName=&CommondityAmount=1&UserName=&AdditionalInfo=&PageUrl=&ReturnUrl=http%3A%2F%2Fbeta.jimulicai.com%2Fpay%2Fnotify%2Fbfpauth&KeyType=1&NoticeType=1&Signature=ca2c026d02bb3eacf75e9242c5f3f557&Username=3",
                    "backurl":"/user/authpay/callback/bfpauth",
                    "paytype":"bfpauth"
                }
            }
...
* 认证支付接口-补填并获取认证支付信息(即绑定银行卡或充值请求参数) /user/authpay/info
    * 请求方式: POST
        
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
        paytype |   string  |   否      |   支付接口类型:llpauth-连连,bfpauth-宝付，默认为由服务端控制
        realname|   string  |   否      |   已实名的无需带上，否则必须带上
        idcard  |   string  |   否      |   已实名的无需带上，否则必须带上
        cardno  |   string  |   是      |   补填时必须带上
        money   |   string  |   否      |   支付金额，注册绑卡时不需要带，默认为0.01
        ...
        JSON:
            ...
            --- 成功：直接将支付请求参数传入sdk进行支付请求 ---
            {
                ...
                "data": {
                    ...
                    "query": { /*支付请求参数列表，见相关文档*/
                        "version": "1.0",
                        "oid_partner": "20151234568123456789",
                        "sign_type": "MD5",
                        "userreq_ip": "127.0.0.1",
                        "id_type": "0",
                        "valid_order": "1440",
                        ...
                        "money_order": "0.01",
                        "notify_url": "http://beta.jimulicai.com/pay/notify/authpay",
                        "url_order": "http://beta.jimulicai.com",
                        "risk_item": "{\"user_info_mercht_userno\":\"111825\",\"user_info_full_name\":\"\\u5f20\\u65ed\\u4e1c\",\"user_info_dt_register\":\"20140204181604\",\"frms_ware_category\":\"2009\",\"user_info_identify_state\":\"0\"}",
                        "acct_name": "张旭东",
...
* 认证支付接口-支付成功主动回调通知 /user/authpay/callback
    ...
    * 请求参数: 此数据参数由支付sdk返回，支持以标准表单或JSON数据格式请求，如下所示
            ...
            --- 表单数据格式 ---
            ret_code=0000&ret_msg=%E4%BA%A4%E6%98%93%E6%88%90%E5%8A%9F&oid_partner=20151234568123456789&dt_order=20141212195518&no_order=1888080800204760&oid_paybill=2014121299451110&money_order=2000.0&result_pay=SUCCESS&settle_date=20141212&sign_type=MD5&sign=b6cd4d7bf2015881fe5423c68eec4bf1
...
---
*  社交绑定-解除绑定 /open/[qq | weixin | weibo]/unbind
    * 请求方式: GET | POST
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
    ...
    * 返回结果：JSON | XML
        ...
        JSON:
            ...
            --- 失败 ---
            {
				"return": 0,
				"errmsg": "登录密码不正确",
				//"errmsg": "重复解绑QQ账户次数过多，禁止解绑",
				"redirect": "/"
            }


---
*  现金券-可使用 /user/coupon/list
*  现金券-已使用 /user/coupon/used
*  现金券-已过期 /user/coupon/expired
    * 请求方式: GET | POST
                    ...
                    "list": [
                        {
							...
							"tid": "0", /*相关投标ID*/
							"money": "30", /*代金券金额*/
							"efftime": "1433123748", /*生效时间*/
							"exptime": "1441072548", /*过期时间*/
							"remark": "", /*备注*/
							"addtime": "1433123748", /*创建时间*/
							"usetime": "0", /*使用时间*/
							"uptime": "0", /*更新时间*/
							"status": "1", /*状态: 0-未激活, 1-可使用, 2-已使用, 3-已过期*/
							"datetime": "2015-06-01 09:55:48", /*格式化时间*/
							"effdate": "2015-06-01", /*格式化生效日期*/
							"expdate": "2015-09-01", /*格式化过期日期*/
							"statusname": "可使用" /*使用状态*/
                        }
                    ],
                }
...
*  红包 /user/reds/record
    * 请求方式: GET | POST
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
        type    |   string  |   否      |   红包类型: -1-所有、1-领取红包、2-奖励红包、3-投标成功、4-投标失败、5-红包过期、6-兑换红包、7-推荐奖励、8-新手奖励
        sdate    |   string  |   否      |  起始日期 
        edate    |   string  |   否      |  截止日期 
                    ...
                    "list": [
                        {
							...
							"exptime": "0", /*过期时间*/
							"remark": "", /*备注*/
							"addtime": "1411816756", /*创建时间*/
							"uptime": "0", /*更新时间*/
							"status": "1", /*状态: 0-待确认, 1-正常*/
							"datetime": "2014-09-27 19:19:16", /*格式化日期*/
							"expdate": "" /*格式化过期日期*/
                        }
                    ],
					"in" : "16.55", /*总收入*/
...
---
*  banner /json/bannerlist
    * 请求方式: GET | POST
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
        type	|   index	|   是      |   banner类型,index-首页
				...
				"data": [
					{
						...
						"status": "1", /*显示状态*/
						"sortno": "0", /*排序*/
						"begintime": "1430755200", /*显示开始时间*/
						"endtime": "1438704000", /*显示结束时间*/
						"addtime": "1434178141", /*添加时间*/
						"uptime": "1434178141" /*更新时间*/
					}
				]
			}

*  合作伙伴、友情链接 /json/linkslist/[cid] 1-合作伙伴
    * 请求方式: GET | POST
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
				...
				"data": [
					{
						...
						"cid": "1", /*分类ID*/
						"title": "hao123", /*名称*/
						"link": "http://www.yiqihao.com", /*链接*/
						"sortno": "1", /*排序*/
						"status": "1", /*显示状态*/
						"logo": "/public/upload/links/imgs/557cf7be25776_200x60.jpg", /*图片地址*/
						"addtime": "1434253299", 
						"uptime": "1434253299"
					}
				]
        ...
        JSON:
            ...
            --- 成功 ---
            {
				...
				"data": [
					...
					"id": "1", 
					"title": "一起好2.0", /*标题*/
					"addtime": "1434178710", /*添加时间*/
					"content": "一起好新版2.0上线通告" /*公告内容*/
					}
				]
			}
...
*  慈善|媒体报道|bbs /article/[charity|media|bbs]list/
    * 请求方式: GET | POST
        参数名  |   类型    |   必需    |   说明
        :---    |   :---:   |   :---:   |   :---
            ...
            --- 成功 ---
            {
				...
				"data": [
					...
					"list": [
						...
						"id": "1",
						"title": "慈善20130101", /*标题*/
						"content": "发生的交罚款了电视剧风口浪尖的首付款量较大时考虑放假啊；可怜的房间的开始啦；房间爱的是；离开附近的顺口溜；啊放假SD卡了；封建时代； ", /*内容*/
						"pic": "upload/article/imgs/557be691d294b_800x600.jpg", /*特色图片*/
						"type": "2", /*类型*/
						"source": "网易新闻", /*文章来源*/
						"addtime": "1434183324", /*发布时间*/
						"uptime": "1434183324", /*更新时间*/
						"status": "1", /*显示状态*/
						"_addtime": "2015-06-13 16:15",
						"_uptime": "2015-06-13 16:15"
						}
					],
						"article_type": 2 /*当前所查询的分类ID*/
					}
				]
			}
